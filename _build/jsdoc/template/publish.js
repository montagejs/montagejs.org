    ...
    if (members.classes.length) {
        ...
        members.classes.forEach(function(c) {
            ...
            if (moduleClasses !== -1 && moduleClasses < members.classes.length) {
                nav += '<details open><summary>Types</summary><ul>';
                moduleClasses = -1;
            }
...
//        nav += '<details><summary>Modules</summary><ul>';
...
//    }
    ...
    if (members.externals.length) {
        nav += '<details><summary>Externals</summary><ul>';
    ...
    if (members.events.length) {
        nav += '<details><summary>Events</summary><ul>';
    ...
    if (members.namespaces.length) {
        nav += '<details><summary>Namespaces</summary><ul>';
    ...
    if (members.mixins.length) {
        nav += '<details><summary>Mixins</summary><ul>';
